...
contract Crowdsale is Ownable{
	...
	// uint public priceTokenWei = 12690355329949;  // 1 ????? ????? 0,01$ (1eth = 788$)
    uint public priceTokenWei = 100000000000;  // 0.0000001 ETH ?? 1 ?????
	...
	function NewStage() private {
		...
		priceTokenWei = 200000000000; // ????? ????????? ?????? 2 ???? ?????? ??? ?? PreICO
