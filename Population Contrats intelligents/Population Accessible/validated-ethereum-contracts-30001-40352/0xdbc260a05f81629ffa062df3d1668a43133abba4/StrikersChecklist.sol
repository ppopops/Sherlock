...
contract StrikersPlayerList is Ownable {
  ...
  constructor() public {
    ...
    addPlayer("Mario Mandžuki?"); // 64
    addPlayer("Sergej Milinkovi?-Savi?"); // 65
    addPlayer("Shinji Kagawa"); // 66
    addPlayer("Granit Xhaka"); // 67
    addPlayer("Andreas Christensen"); // 68
    addPlayer("Piotr Zieli?ski"); // 69
    ...
    addPlayer("Zlatan Ibrahimovi?"); // 101
  }
...
contract StrikersChecklist is StrikersPlayerList {
  ...
  function deployStepOne() external onlyOwner {
    ...
    _addOriginalChecklistItem(6, RarityTier.Gold); // 006 Modri?
  ...
  function deployStepTwo() external onlyOwner {
    ...
    _addOriginalChecklistItem(43, RarityTier.Silver); // 043 Rakiti?
    ...
    _addOriginalChecklistItem(57, RarityTier.Bronze); // 057 Mati?
    ...
    _addOriginalChecklistItem(64, RarityTier.Bronze); // 064 Mandžuki?
    _addOriginalChecklistItem(65, RarityTier.Bronze); // 065 Milinkovi?-Savi?
  ...
  function deployStepThree() external onlyOwner {
    ...
    _addOriginalChecklistItem(69, RarityTier.Bronze); // 069 Zieli?ski
  ...
  function deployStepFour() external onlyOwner {
    ...
    _addIconicChecklistItem(6, RarityTier.IconicInsert); // 106 Modri?
