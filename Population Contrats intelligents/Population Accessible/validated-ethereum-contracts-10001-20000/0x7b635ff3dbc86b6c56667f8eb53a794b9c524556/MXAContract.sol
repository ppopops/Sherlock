...
contract MXAContract is PausableToken {
    ...
    constructor() public {
        totalSupply_ = 30 * (10 ** 8) * (10 ** uint256(decimals));	//???? 30?
        balances[ico] = totalSupply_ * 30 / 100;					//??+??+?? 30%
        balances[community] = totalSupply_ * 30 / 100;				//???? 30%
        balances[team] = totalSupply_ * 20 / 100;					//?? 20%
        balances[foundation] = totalSupply_ * 20 / 100;				//??? 20%
