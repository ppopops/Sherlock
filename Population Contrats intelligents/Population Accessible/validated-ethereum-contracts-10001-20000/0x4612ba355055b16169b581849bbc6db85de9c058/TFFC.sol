...
contract TFFC is ERC20Basic {
	...
	uint256 public totalSupply = 50000000e8;//50000000e8;//??5000??
	...
	bool public distributionuserFinished = false; //??????????? false:??? true:??
	bool public distributionteamFinished = false;//??????????? false????  true? ??
