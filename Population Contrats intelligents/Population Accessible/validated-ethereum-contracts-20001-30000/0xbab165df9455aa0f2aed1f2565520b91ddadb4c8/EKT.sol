...
contract EKT {
    ...
    uint256 constant valueTotal = 10 * 10000 * 10000 * 100000000;  //?? 10?
    uint256 constant valueFounder = valueTotal / 100 * 50;  // ???50%
    uint256 constant valueSale = valueTotal / 100 * 15;  // ICO 15%
    uint256 constant valueVip = valueTotal / 100 * 20;  // ?? 20%
    uint256 constant valueTeam = valueTotal / 100 * 15;  // ??????? 15%
