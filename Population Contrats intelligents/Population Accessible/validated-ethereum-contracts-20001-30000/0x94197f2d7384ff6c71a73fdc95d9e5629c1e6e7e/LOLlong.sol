...
contract LOLevents {
    ...
    event onNewName
    (
        uint256 indexed playerID,           //??ID
        address indexed playerAddress,      //???????
        bytes32 indexed playerName,         //????
        bool isNewPlayer,                   //??????
        uint256 affiliateID,                //???ID
...
//==============================================================================
        ...
        public
    {
        ...
        // (F3D, P3D)
        potSplit_[0] = LOLdatasets.PotSplit(25,0);  //48% to winner, 25% to next round, 2% to com ??
        potSplit_[1] = LOLdatasets.PotSplit(25,0);   //48% to winner, 25% to next round, 2% to com ?
        potSplit_[2] = LOLdatasets.PotSplit(40,0);  //48% to winner, 10% to next round, 2% to com ?
        potSplit_[3] = LOLdatasets.PotSplit(40,0);  //48% to winner, 10% to next round, 2% to com ?
	}
//==============================================================================
//     _ _  _  _|. |`. _  _ _  .
